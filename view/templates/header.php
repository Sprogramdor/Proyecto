    ...
    <header class="header">
        <div class="container menu">
            ...
            <nav>
                ...
                <a class="menu__link" href="index.php?c=index&f=index&p=productos">Productos</a>
                <a class="menu__link" href="index.php?c=index&f=index&p=nosotros">Nosotros</a>
                <a class="menu__link" href="index.php?c=index&f=index&p=contacto">Contecto</a>
            </nav>
            ...
            <a class="button" href="index.php?c=index&f=index&p=login"> Cerrar Sesion</a>
               <?php }else{ ?>
                    <a class="button" href="index.php?c=index&f=index&p=login">Iniciar Sesion</a>
               <?php }?>
