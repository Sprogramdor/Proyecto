<?php require_once HEADER; ?>
    ...
    <meta name="description"
        content="Mycake es una tienda online en la cual informa los diversos productos que tienen en venta a sus clientes, tortas y bocaditos siempre de frescos">
    <meta name="keywords"
        content="Mycake, pasteles, bocadillos, pastel de chocolate, caracoles de manjar, ofertas en pasteles, descuentos en pasteles, pastelería guayaquil, MyCake.exe, ofertas en pasteles ">
    <meta name="author" content="Ramos Mesias Mauro Fabrizio">
    ...
    <style>
        ...
        * p {
        ...
        .article__text span:nth-child(1) {
            color: green;
            font-weight: 700;
        }

        .article__text span:nth-child(2) {
            font-weight: 700;
            text-transform: uppercase;
        }

        .article__text span:last-of-type {
            font-style: italic;
        }
    </style>
</head>
