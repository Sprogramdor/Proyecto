...
<main class="Grid_container">
        ...
        <div class="frase" style="display: flexbox;">
            ...
            <blockquote style="border-top: #645353 solid; padding-top: 40px;">
                ...
                <span style="padding-left: 400px; margin-right: 45px;">¿Quieres dejarnos un mensaje? </span>
                <a href="escribenos.html" style="font-family:Roboto, sans-serif;" class="button">
                    Escribenos</a>
