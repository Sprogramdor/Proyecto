    ...
    <main id="contactenos">
        ...
        <div id="referencia " style=" display: flex; justify-content: center; align-items: center; background-color:white; width:100%; height:90%; ">
            <div class="enlaces" style="display: flex; flex-direction: column; width: 30%;">
                ...
                <br /><a class="button" href="opinion.html" style="text-align: center;">Llenar Encuesta </a>
            </div>
            <div class="enlaces" style="display: flex; flex-direction: column; width: 30%;">
                ...
                <br /><a class="button" href="proveedor.html" style="text-align: center;">Formulario para proveedores</a>
