...
class VentasController {
    ...
    public function new() {
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          //  verificaciones
          if(!isset($_POST['codipro']) && !isset($_POST['nomprod']) && !isset($_POST['stock']) &&!isset($_POST['prepod']))
          { header('');}
   ...
   public function edit(){
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {// actualizar
      // verificaciones
          ...
          // leer parametros
          if(!empty($_POST['codipro']) && !empty($_POST['nomprod']) && !empty($_POST['stock']) &&!empty($_POST['prepod']))
          {
          $prod = new Producto();
          // lectura de parametros
          $prod->setid_producto(htmlentities($_POST['id']));
          $prod->setcod_producto(htmlentities( test_input($_POST['codiprod'])));
          $prod->setprod_nombre(htmlentities($_POST['nomprod']));
